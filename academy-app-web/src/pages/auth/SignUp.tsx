...
export default function SignUp() {
  ...
  return (
    <>
      <h2 className="text-dark text-[28px] leading-tight font-bold">Crea tu cuenta</h2>
      <p className="mt-2 text-sm text-gray-400">Ingresa tus datos para comenzar</p>

      {error && <p className="mt-4 rounded-lg bg-red-50 px-4 py-3 text-sm text-red-600">{error}</p>}

      <form onSubmit={handleSubmit(onSignUp)} className="mt-8 flex flex-col gap-5">
        <Input
