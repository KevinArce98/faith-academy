...
export const clerkLocalization = {
	already_a_member_in_organization:
		'{{email}} ya es miembro de la organización.',
	...
	form_email_address_blocked:
		'Esta dirección de correo electrónico ha sido bloqueada.',
	...
	form_identifier_not_found:
		'No se encontró ninguna cuenta con este identificador.',
	...
	form_password_not_strong_enough:
		'Tu contraseña no es lo suficientemente fuerte.',
	...
	identification_deletion_failed:
		'No se pudo eliminar el método de identificación.',
	...
	organization_domain_common:
		'Este dominio es demasiado común y no puede ser usado.',
	...
	passkey_registration_cancelled:
		'El registro de passkey fue cancelado o expiró.',
	passkey_retrieval_cancelled:
		'La verificación de passkey fue cancelada o expiró.',
	...
	zxcvbn: {
		...
		warnings: {
			...
			straightRow:
				'Las filas rectas de teclas en tu teclado son fáciles de adivinar.',
			topHundred: 'Esta es una contraseña frecuentemente usada.',
			topTen: 'Esta es una contraseña muy usada.',
			userInputs:
				'No debería haber datos personales o relacionados con la página.',
