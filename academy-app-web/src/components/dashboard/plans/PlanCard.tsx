...
export function PlanCard({ plan, isAdmin = false, onEdit, onDelete, onToggle }: PlanCardProps) {
  ...
  return (
    ...
    >
      ...
      {plan.description && <p className="text-sm leading-snug text-gray-400">{plan.description}</p>}
      ...
      {(onEdit || onDelete) && (
        <div className="mt-auto flex gap-2">
          ...
          {onDelete && (
            <Button color="danger" onClick={() => onDelete(plan)} aria-label="Eliminar plan">
