    ...
    startTransition(async () => {
      try {
        const payload = {
          ...
          classesPerWeek: form.unlimited ? 0 : parseInt(form.classesPerWeek || '0', 10),
        ...
        >
          <div className="flex-1 overflow-y-auto">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 p-6">
              ...
              <div className="space-y-3 rounded-xl bg-gray-50 p-4">
                <label className="flex cursor-pointer items-start gap-3">
                  ...
                  <span className="text-sm">
                    <span className="text-dark font-semibold">Clases ilimitadas (indefinidas)</span>
                ...
                <label className="flex cursor-pointer items-start gap-3">
                  ...
                  <span className="text-sm">
                    <span className="text-dark font-semibold">Visible para alumnos</span>
                    <span className="block text-xs text-gray-500">
                      Desmárcalo para un plan oculto tipo beca (solo lo asigna el admin)
                    </span>
                  </span>
                </label>
                <label className="flex cursor-pointer items-start gap-3">
                  ...
                  <span className="text-sm">
                    <span className="text-dark font-semibold">Plan de una sola clase</span>
                    <span className="block text-xs text-gray-500">
              ...
              {error && (
                <p className="bg-danger/10 text-danger rounded-lg px-4 py-2 text-sm">{error}</p>
              )}
