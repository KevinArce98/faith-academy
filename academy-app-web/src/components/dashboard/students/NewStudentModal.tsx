...
import type { Plan } from '@shared/interfaces/students';
import { modalVariants, overlayVariants } from '@/lib/animations';
import { Input } from '@/components/ui/Input';
import { Select } from '@/components/ui/Select';
import { Textarea } from '@/components/ui/Textarea';
import { Button } from '@/components/ui/Button';
import { createStudentSchema, type CreateStudentInput } from '@shared/validations/students';
        ...
        {tempPassword ? (
          ...
          <>
            ...
            <form className="space-y-5 p-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              <Select label="Plan de membresia" error={fieldErrors.planId?.message} {...register('planId')}>
