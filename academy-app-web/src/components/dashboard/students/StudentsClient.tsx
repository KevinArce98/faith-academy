...
import { Check, Clock, Eye, Loader2, Pencil, Plus, Search, Trash2 } from 'lucide-react';
...
export function StudentsClient({ students, plans, total }: StudentsClientProps) {
      ...
      >
        <button
          ...
          className={cn(
            ...
            state === 'paid' && 'border-success/30 bg-success/10 text-success hover:bg-success/20',
            state === 'pending' &&
              'border-warning/40 bg-warning/10 text-warning hover:bg-warning/20',
            state === 'expired' && 'border-danger/30 bg-danger/10 text-danger hover:bg-danger/20'
          )}
        >
          {loading ? (
                ...
                <div className="mb-2 flex items-center gap-2.5">
                  ...
                  <span
                    className={cn(
                      ...
                      student.isActive ? 'bg-success/10 text-success' : 'bg-gray-100 text-gray-500'
                    )}
                  >
                    {student.isActive ? 'ACTIVO' : 'INACTIVO'}
                  </span>
