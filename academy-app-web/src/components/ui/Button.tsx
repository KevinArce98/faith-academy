...
// ─── Color ───────────────────────────────────────────────────────────────────
export type ButtonColor = 'primary' | 'dark' | 'danger' | 'success' | 'warning' | 'neutral';
...
const styles: Record<ButtonVariant, Record<ButtonColor, string>> = {
  ...
  contained: {
    ...
    dark: 'bg-dark         text-white border border-dark         hover:bg-dark-mid       hover:border-dark-mid       active:bg-gray-900',
    danger:
  ...
  outlined: {
    ...
    dark: 'bg-transparent  text-dark    border border-dark       hover:bg-dark/10        active:bg-dark/20',
    danger:
  ...
  text: {
    ...
    dark: 'bg-transparent  text-dark    border border-transparent hover:bg-dark/10       active:bg-dark/20',
    danger:
