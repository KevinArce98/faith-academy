...
export function VideoLibraryClient({ contents }: VideoLibraryClientProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Tag pills */}
      <div className="flex gap-2 overflow-x-auto pb-1 md:flex-wrap" style={{ WebkitOverflowScrolling: 'touch' }}>
        {tags.map((tag) => (
          <Button
            key={tag}
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-1 flex-col gap-2 p-4">
                <h3 className="text-dark line-clamp-2 text-sm font-semibold">
                  {content.title}
                </h3>
                {isDocument ? (
                  ...
                  <p className="text-xs text-gray-400">
                    Subido {timeAgo(content.createdAt)}
                  </p>
                )}
                {!isDocument && (
