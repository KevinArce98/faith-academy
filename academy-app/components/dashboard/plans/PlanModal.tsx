...
import { INTERVAL_OPTIONS } from '@/interfaces/plans';
import { planFormSchema } from '@/lib/validations/plans';
import type { Plan, PlanFormValues } from '@/interfaces/plans';
...
export function PlanModal({ plan, onClose, onSuccess }: PlanModalProps) {
  ...
  function onSubmit(form: PlanFormValues) {
    ...
    startTransition(async () => {
      ...
      // Build an optimistic plan object to update the UI immediately
      const updated: Plan = {
