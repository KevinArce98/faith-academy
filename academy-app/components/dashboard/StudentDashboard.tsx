      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-3 md:gap-5">
        ...
        <div className="rounded-2xl border border-gray-50 bg-white p-4 shadow-sm md:p-5">
          <div className="mb-2 flex items-start justify-between md:mb-3">
            <p className="text-xs text-gray-400 md:text-sm">Creditos Disponibles</p>
            <CreditCard className="h-4 w-4 text-gray-300 md:h-5 md:w-5" />
          </div>
          <p className={cn('text-2xl font-bold md:text-4xl mb-1', creditBalance > 0 ? 'text-dark' : 'text-danger')}>
            {creditBalance}
          </p>
        ...
        <div className="rounded-2xl border border-gray-50 bg-white p-4 shadow-sm md:p-5">
          ...
          {activeOrder ? (
            ...
            <>
              <p className="text-gray-300 text-lg font-bold md:text-xl mb-1">—</p>
              <Link
                href="/plans"
      ...
      <div className="flex flex-col gap-4 md:grid lg:grid-cols-[1fr_340px] lg:gap-6">
        ...
        <div className="rounded-2xl border border-gray-50 bg-white p-4 shadow-sm md:p-6">
          <div className="mb-5 flex items-center justify-between">
            <h2 className="text-dark text-base font-bold">Mis Proximas Clases</h2>
            <Link
              href="/classes"
          ...
          {upcomingClasses.length === 0 ? (
            <div className="py-8 text-center">
              ...
              <p className="text-sm text-gray-400">No tienes clases reservadas</p>
              <Link
                href="/classes"
