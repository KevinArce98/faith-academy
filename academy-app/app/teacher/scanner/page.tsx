    ...
    reader
      .decodeFromVideoDevice(
        ...
        async (result, error) => {
          ...
          // Debounce: ignore if same token scanned within 3 seconds
          ...
          try {
            ...
            const data: Omit<ScanResult, 'scannedAt'> = await res.json();
            setHistory((prev) =>
                ...
                {entry.ok && (
                  <>
                    <span
                      ...
                      style={{
                        color: entry.nearExpiry ? studioConfig.colors.warning : studioConfig.colors.success,
                      }}
                    >
