...
-- CreateIndex
CREATE INDEX "MembershipOrder_studentId_idx" ON "MembershipOrder"("studentId");

-- CreateIndex
CREATE INDEX "MembershipOrder_status_idx" ON "MembershipOrder"("status");

-- CreateIndex
CREATE INDEX "MembershipOrder_expiresAt_idx" ON "MembershipOrder"("expiresAt");

-- CreateIndex
CREATE INDEX "MembershipOrder_studentId_status_idx" ON "MembershipOrder"("studentId", "status");

-- CreateIndex
CREATE INDEX "CreditLedger_studentId_createdAt_idx" ON "CreditLedger"("studentId", "createdAt" DESC);
...
-- CreateIndex
CREATE INDEX "Attendance_classId_status_idx" ON "Attendance"("classId", "status");

-- CreateIndex
CREATE INDEX "ClassWaitlist_classId_position_idx" ON "ClassWaitlist"("classId", "position");
...
-- AddForeignKey
ALTER TABLE "EmailToken" ADD CONSTRAINT "EmailToken_userId_fkey" FOREIGN KEY ("userId") REFERENCES "UserProfile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
